...
<html lang="en">
    ...
    <body>
        <?php require_once("./config.php");
              if(isset($_GET['gtotal']) && isset($_GET['totalquant']))
      {
          $totalprice = $_GET['gtotal'];
          $ttp = number_format($totalprice, 0, ',', '.');
          $totalquant = $_GET['totalquant'];
      } ?>             
        <div class="container">
                ...
                <form action="./vnpay_create_payment.php" id="create_form" method="post">       
                    ...
                    <div class="form-group">
                        ...
                        <select name="order_type" id="order_type" class="form-control">
                            <option value="billpayment">Thanh toán Online</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="order_id">Mã hóa đơn</label>
                        <input class="form-control" id="order_id" name="order_id" type="text" value="<?php $ses_ID = session_id();
                        echo $ses_ID . date("Ymd") .'-'. random_int(1, 100); ?>"/>
                    </div>
                    <div class="form-group">
                        <label for="amount">Số tiền</label>
                        <input class="form-control" id="amount"
                               name="amount" type="number" value="<?php echo $totalprice?>"/>
                    </div>
                    <div class="form-group">
                        <label for="order_desc">Nội dung thanh toán</label>
                        <textarea class="form-control" cols="20" id="order_desc" name="order_desc" rows="2"><?php echo "bạn đã mua tổng cộng ".$totalquant." món tại tử kỳ mbshop với giá tiền là ".$ttp." VND"?></textarea>
                    </div>
                    <div class="form-group">
